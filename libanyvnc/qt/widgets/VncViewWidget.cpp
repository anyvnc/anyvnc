...
namespace AnyVncQt::Widgets
{

VncViewWidget::VncViewWidget( const QString& host, int port, QWidget* parent ) :
	QWidget( parent ),
	VncView( new Core::VncConnection(QCoreApplication::instance()) )
{
